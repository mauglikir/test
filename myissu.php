                    ...
                    <div class="aui-tabs horizontal-tabs">
                        ...
                        <div class="tabs-pane active-pane" id="tabs-example-first">
                            <form class="aui top-label">
                                ...
                                <div class="field-group">
                                    <label for="text-input">Components</label>
                                    <input class="text long-field" type="text" id="text-input" name="text-input" title="Text input">
                                </div>
                                <div class="field-group">
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <textarea class="textarea long-field" name="comment" id="textarea-id" placeholder="Your comment here..."></textarea>
                                    </div>
                                </div>
                                <div class="buttons-container d-flex d-flex-just">
                                    
                                        <button class="aui-button aui-button-primary">Sing Up</button>
                        ...
                        <div class="tabs-pane" id="tabs-example-second">
                            <form class="aui top-label">
                                <div class="field-group">
                                    <label for="text-input">First Name<span class="aui-icon icon-required">required</span></label>
                                    <input class="text long-field" type="text" id="text-input" name="text-input" title="Text input">
                                </div>
                                <div class="field-group">
                                    <label for="text-input">Last Name<span class="aui-icon icon-required">required</span></label>
                                    <input class="text long-field" type="text" id="text-input" name="text-input" title="Text input">
                                </div>
                                <div class="field-group">
                                    <label for="text-input">Company<span class="aui-icon icon-required">required</span></label>
                                    <input class="text long-field" type="text" id="text-input" name="text-input" title="Text input">
                                </div>
                                <div class="field-group">
                                ...
                                <div class="field-group">
                                    <label for="text-input">Please enter the word as shown below<span class="aui-icon icon-required">required</span></label>
                                    <input class="text long-field" type="text" id="text-input" name="text-input" title="Text input">
                                </div>
                                <div class="buttons-container d-flex d-flex-just">
