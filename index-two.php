...
<body>
    ...
    <div class="aui-main-page aui-page-panel-tabs">
            <div class="aui-tabs vertical-tabs">
                <ul class="tabs-menu tabs-menu-new">
                    <li class="menu-item active-tab">
                        <a href="#tabs-example-first">Our Apps</a>
                    </li>
                    <li class="menu-item">
                        <a href="#tabs-example-second">Paid Support</a>
                    </li>
                    <li class="menu-item">
                        <a href="#tabs-example-second">Hosting</a>
                    </li>
                    <li class="menu-item">
                        <a href="#tabs-example-second">Consulting</a>
                    </li>
                </ul>
